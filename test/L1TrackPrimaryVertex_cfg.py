...
process.load("L1Trigger.TrackFindingTracklet.L1TechPropPrimaryVertexProducer_cfi")
process.L1TechPropPrimaryVertexProducer.L1TrackInputTag = cms.InputTag("TTTracksFromTracklet","Level1TTTracks")
